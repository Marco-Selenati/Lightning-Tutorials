...
$content .= <<<'EOD'
<a href="HTML5_2_Aufbau eines HTML-Dokuments.php"><button type="button" class="btn btn-primary">Vorheriges</button></a>
EOD
;
$content .= <<<'EOD'
<a href="HTML5_4_Bilder einfuegen.php"><button type="button" class="btn btn-primary">Nächstes</button></a>
EOD
;
$rootoff = "../";
