...
$content .= format_code_inline_p(<<<'EOD'Jedes HTML-Dokument sollte mit der Zeile
<!doctype html>
beginnen, die dem Browser sagt, dass dieses Dokument vom Typ HMTL ist. Danach folgen die html Start und Endtags.

EOD
);
$content .= format_code_block_p(<<<'EOD'<!doctype html>
<html>
</html>

EOD
);
$content .= format_code_inline_p(<<<'EOD'In diese hinein kommen der head und der body
...
$content .= format_code_inline_p(<<<'EOD'Im head werden gewisse Informationen die für die ganze Seite gelten gespeichert, wie zum Beispiel der <title>, oder die Kodierung. In den body kommt der eigentliche Inhalt der Seite, also alle <h1> und <p> Tags.
